                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                            <label >Data Master &nbsp</label><i class="fas fa-caret-square-right"></i><label>&nbsp Jenis Belanja</label>
                                    ...
                                    <div class="col-6" >
                                        <div class=" float-right">
                                            ...
                                            <i class="fas fa-plus-circle"></i><b> &nbspTambah Jenis Belanja</b>
                                            </button> 
                                        </div>
                                    </div>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Tambah Jenis Belanja</h5>
                                                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"><i class="fas fa-window-close"></i></button>
                                                    </div>                                                    
                                                    <form action="/data_jenis/create" method="POST" class="custom-validation">
                                                    {{csrf_field()}}
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                <label>Jenis Belanja</label>
                                                                <div>
                                                                    <input type="text" name="nama_jenis" class="form-control" required placeholder="Masukkan jenis belanja ..."/>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Rekening Belanja</label>  
                                                                <div>
                                                                    <input type="text" name="nomer_jenis" class="form-control" required placeholder="Masukkan nomer rekening belanja ..."/>
                                                                </div>
                                                            </div>
                                                        </div>                                                    
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" style="border-collapse: collapse; border-spacing: 0px; width: 100%;" role="grid" aria-describedby="datatable-buttons_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th style="display: none;">ID</th>
                                            <th style="display: none;">ID</th>
                                            <th class="sorting" tabindex="0" aria-controls="datatable-buttons" style="width: 50%;" aria-label="Position: activate to sort column ascending">Jenis Belanja</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td >{{++$no}}.</td>
                                            <td style="display: none;">{{$jenis->id_jenis}}</td>
                                            <td style="display: none;"></td>
                                            <td style="display: none;"></td>
                                            <td>{{$jenis->nama_jenis}}</td>
                                            <td>{{$jenis->nomer_jenis}}</td>
                                            <td align="center">
                                                <button type="button" class="btn btn-warning btn-sm edit_jenis"><i class="fas fa-edit"></i></button> &nbsp
                                                <button type="button" class="btn btn-danger btn-sm delete_jenis"><i class="fas fa-trash-alt"></i></button>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                            ...
                                            {{csrf_field()}}
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label>Jenis Belanja</label>  
                                                        <div>
                                                            <input type="text" name="nama_jenis" id="nama_jenis" class="form-control" required placeholder="Masukkan jenis belanja ..."/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Rekening Belanja</label>  
                                                        <div>
                                                            <input type="text" name="nomer_jenis" id="nomer_jenis" class="form-control" required placeholder="Masukkan nomer rekening belanja ..."/>
                                                        </div>
                                                    </div>
                                                </div>                                                    
                                                <div class="modal-footer">
