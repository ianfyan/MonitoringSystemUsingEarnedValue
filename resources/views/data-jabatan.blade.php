                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                            <label >Manajemen Users &nbsp</label><i class="fas fa-caret-square-right"></i><label>&nbsp Kategori Jabatan</label>
                                      
                                    </div>
                                    <div class="col-6" ><div class=" float-right">
                                        <!-- Button trigger modal -->
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="fas fa-plus-circle"></i><b> &nbspTambah Kategori</b>
                                        </button> 
                                    </div></div>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Tambah Kategori Jabatan</h5>
                                                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"><i class="fas fa-window-close"></i></button>
                                                    </div>                                                    
                                                    <form action="/data_jabatan/create" method="POST" class="custom-validation">
                                                    {{csrf_field()}}
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                <label>Nama Jabatan</label>
                                                                <div>
                                                                    <input type="text" name="nama_jabatan" class="form-control" required placeholder="Masukkan nama jabatan ..."/>
                                                                </div>
                                                            </div>
                                                        </div>                                                    
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" style="border-collapse: collapse; border-spacing: 0px; width: 100%;" role="grid" aria-describedby="datatable-buttons_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th style="display: none;">ID</th>
                                            <th style="display: none;">ID</th>
                                            <th class="sorting" tabindex="0" aria-controls="datatable-buttons" style="width: 75%;" aria-label="Position: activate to sort column ascending">Nama Jabatan</th>
                                            <th style="width: 20%;">Tindakan</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach($data_jabatan as $no => $jabatan)
                                        <tr>
                                            <td >{{++$no}}.</td>
                                            <td style="display: none;">{{$jabatan->id_jabatan}}</td>
                                            <td style="display: none;"></td>
                                            <td style="display: none;"></td>
                                            <td>{{$jabatan->nama_jabatan}}</td>
                                            <td align="center">
                                                <button type="button" class="btn btn-warning btn-sm edit_jabatan"><i class="fas fa-edit"></i></button> &nbsp
                                                <button type="button" class="btn btn-danger btn-sm delete_jabatan"><i class="fas fa-trash-alt"></i></button>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                            ...
                                            {{csrf_field()}}
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label>Nama Jabatan</label>  
                                                        <div>
                                                            <input type="text" name="nama_jabatan" id="nama_jabatan" class="form-control" required placeholder="Masukkan nama jabatan ..."/>
                                                        </div>
                                                    </div>
                                                </div>                                                    
                                                <div class="modal-footer">
